...
// â”€â”€â”€ Inline Badge Components â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ Print functions â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ View Modal (read-only) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
          ...
          <div style={ms.viewBody}>
            ...
            <div style={ms.sectionBlock}>
              ...
              <div style={ms.fieldGrid}>
                ...
                <div style={ms.fieldItem}><span style={ms.fLabel}>Date</span><span style={ms.fValue}>{rec.date || "â€”"}</span></div>
      ...
      <div style={s.card}>
        ...
        <div style={s.cardTopRow}>
          <div>
            ...
            <p style={s.cardSubtitle}>All Purchased Vehicles â€” Individual & Showroom Records (Read-Only)</p>
          </div>
        </div>
        ...
        <div style={s.searchRow}>
          <input
            type="text"
            placeholder="Search by Chassis No, Engine No, Reg. No, Seller Name, Phone, Brandâ€¦"
            value={searchQuery}
        ...
        <div style={s.tableWrapper}>
          <table style={s.table}>
            ...
            <tbody>
              {loading ? (
                <tr><td colSpan={13} style={s.emptyRow}>Loadingâ€¦</td></tr>
              ) : records.length === 0 ? (
                <tr>
                ...
                records.map((rec, i) => (
                  <tr key={`${rec.purchaseType}-${rec.id}`} style={i % 2 === 0 ? s.trEven : s.trOdd}>
                    ...
                    <td style={s.td}>{rec.sellerName || "â€”"}</td>
                    <td style={s.td}>{rec.brand || "â€”"}</td>
                    <td style={s.td}>{rec.modelYear || "â€”"}</td>
                    <td style={s.td}>{rec.engineCC || "â€”"}</td>
                    <td style={s.td}>{rec.color || "â€”"}</td>
                    <td style={{ ...s.td, fontFamily: "monospace", fontSize: ".8rem" }}>{rec.chassisNo || "â€”"}</td>
                    <td style={{ ...s.td, fontFamily: "monospace", fontSize: ".8rem" }}>{rec.engineNo || "â€”"}</td>
                    <td style={{ ...s.td, fontFamily: "monospace", fontSize: ".8rem" }}>{rec.regNo || "â€”"}</td>
