...
// â”€â”€â”€ Print functions (unchanged) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

function printIndividualReceipt(rec: PurchaseRecord) {
  const serialNumber = String(rec.srNo).padStart(4, "0");
  const savedTime = rec.savedTime ?? "â€”";
  ...
  const v = (x?: string | number) => x !== undefined && x !== null && String(x).trim() !== "" ? String(x) : "â€”";
  ...
  const bioHtml = rec.biometric ? `<span class="bio-chip">&#9679; ${rec.biometric}</span>` : `<span class="none-text">â€”</span>`;
            ...
            <div style={ms.viewBody}>
              ...
              <div style={ms.sectionBlock}>
                ...
                <div style={ms.fieldGrid}>
                  <div style={ms.fieldItem}><span style={ms.fLabel}>{isIndividual ? "Seller Name" : "Showroom Name"}</span><span style={ms.fValue}>{rec.sellerName || "â€”"}</span></div>
                  {isIndividual && <div style={ms.fieldItem}><span style={ms.fLabel}>Father Name</span><span style={ms.fValue}>{rec.fatherName || "â€”"}</span></div>}
                  ...
                  {isIndividual && <div style={ms.fieldItem}><span style={ms.fLabel}>CNIC</span><span style={ms.fValue}>{rec.cnic || "â€”"}</span></div>}
      ...
      <div style={s.card}>
        ...
        <div style={s.tableWrapper}>
          <table style={s.table}>
            ...
            <tbody>
              {loading ? (
                <tr><td colSpan={isIndividual ? 8 : 6} style={s.emptyRow}>Loadingâ€¦</td></tr>
              ) : records.length === 0 ? (
                ...
                records.map((rec, i) => (
                  <tr key={rec.id} style={i % 2 === 0 ? s.trEven : s.trOdd}>
                    ...
                    {isIndividual && <td style={s.td}>{rec.cnic || "â€”"}</td>}
