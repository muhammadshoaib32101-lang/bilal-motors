...
// â”€â”€ Field component at module level â€” prevents remount on every render â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
export default function SettingsPage() {
  ...
  return (
    <div style={s.page}>
      ...
      {/* Light placeholder styling â€” cannot be done with inline styles */}
      <style>{`
      ...
      <div style={s.content}>
        ...
        {/* Showroom ID â€” read-only */}
        <div style={s.formRow}>
          <span style={s.formLbl}>Showroom ID</span>
          <span style={s.formRoVal}>{showroomId}</span>
        </div>
        <p style={s.noteText}>Auto-generated â€” cannot be changed.</p>
