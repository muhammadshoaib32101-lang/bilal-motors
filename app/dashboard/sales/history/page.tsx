...
const NAV_ITEMS: string[] = ["Inventory", "Sales", "Purchase", "Registration", "Settings"];
const TABS: string[] = ["New Sale", "Sales History"];
...
<div class="page">
  ...
  <div class="section">
    ...
    <div class="row">
      <div class="f"><div class="f-label">Buyer Name</div><div class="f-value">${v(rec.customerName)}</div></div>
      <div class="f"><div class="f-label">Father Name</div><div class="f-value">${v(rec.fatherName)}</div></div>
      <div class="f"><div class="f-label">Phone No.</div><div class="f-value">${v(rec.phoneNumber)}</div></div>
      <div class="f"><div class="f-label">CNIC</div><div class="f-value">${v(rec.cnic)}</div></div>
    </div>
    <div class="row">
...
// â”€â”€â”€ View / Edit Modal â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            ...
            <div style={ms.viewBody}>
              ...
              <div style={ms.sectionBlock}>
                ...
                <div style={ms.fieldGrid}>
                  <div style={ms.fieldItem}><span style={ms.fLabel}>Customer Name</span><span style={ms.fValue}>{rec.customerName || "â€”"}</span></div>
                  <div style={ms.fieldItem}><span style={ms.fLabel}>Father Name</span><span style={ms.fValue}>{rec.fatherName || "â€”"}</span></div>
                  <div style={ms.fieldItem}><span style={ms.fLabel}>Phone</span><span style={ms.fValue}>{rec.phoneNumber || "â€”"}</span></div>
                  ...
                  <div style={ms.fieldItemWide}><span style={ms.fLabel}>Address</span><span style={ms.fValue}>{rec.address || "â€”"}</span></div>
                </div>
              </div>
              ...
              <div style={ms.sectionBlock}>
                ...
                <div style={ms.fieldGrid}>
                  <div style={ms.fieldItem}><span style={ms.fLabel}>Brand</span><span style={ms.fValue}>{rec.brand || "â€”"}</span></div>
                  <div style={ms.fieldItem}><span style={ms.fLabel}>Model Year</span><span style={ms.fValue}>{rec.modelYear || "â€”"}</span></div>
                  <div style={ms.fieldItem}><span style={ms.fLabel}>Engine CC</span><span style={ms.fValue}>{rec.engineCC || "â€”"}</span></div>
                  <div style={ms.fieldItem}><span style={ms.fLabel}>Color</span><span style={ms.fValue}>{rec.color || "â€”"}</span></div>
                  ...
                  <div style={ms.fieldItem}><span style={ms.fLabel}>Reg. No.</span><span style={ms.fValue}>{rec.regNo || "â€”"}</span></div>
                  <div style={ms.fieldItem}><span style={ms.fLabel}>Status</span><span style={ms.fValue}>{rec.status || "â€”"}</span></div>
                </div>
              </div>
                ...
                <div style={{ display: "flex", gap: 20 }}>
                  ...
                  <div style={{ flex: 1, borderLeft: `1px solid ${BORDER}`, paddingLeft: 20 }}>
                    ...
                    {rec.biometric
                      ...
                      : <span style={{ fontSize: ".82rem", color: MUTED }}>â€”</span>}
                  </div>
                </div>
              </div>
                  ...
                  {[
                    ...
                    <div key={w.label} style={{ padding: "12px 16px", background: "#fafbfc", border: `1px solid ${BORDER}`, borderRadius: 8 }}>
                      ...
                      <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                        <div style={ms.fieldItem}><span style={ms.fLabel}>Name</span><span style={ms.fValue}>{w.name || "â€”"}</span></div>
                        <div style={ms.fieldItem}><span style={ms.fLabel}>Phone</span><span style={ms.fValue}>{w.phone || "â€”"}</span></div>
                        <div style={ms.fieldItem}><span style={ms.fLabel}>CNIC</span><span style={ms.fValue}>{w.cnic || "â€”"}</span></div>
                      </div>
                    </div>
                  ))}
                </div>
            ...
            <div style={ms.editBody}>
              ...
              <div style={ms.editSection}>
                ...
                <div style={ms.editGrid4}>
                  ...
                  <div style={ms.editField}>
                    ...
                    <input style={ms.editInput} value={edit.phoneNumber} maxLength={11} onChange={e => setF("phoneNumber", e.target.value)} />
                  </div>
                  <div style={ms.editField}>
                ...
                <div style={{ ...ms.editGrid4, marginTop: 14 }}>
                  <div style={ms.editField}>
                    ...
                    <input style={ms.editInput} value={edit.cnic} maxLength={15} onChange={e => setF("cnic", e.target.value)} />
                  </div>
              ...
              <div style={ms.editSection}>
                ...
                <div style={ms.editGrid4}>
                  <div style={ms.editField}>
                    ...
                    <select style={ms.editSelect} value={edit.brand} onChange={e => setF("brand", e.target.value)}>
                  ...
                  <div style={ms.editField}>
                    ...
                    <select style={ms.editSelect} value={edit.engineCC} onChange={e => setF("engineCC", e.target.value)}>
                      <option value="">Select</option>
                      {ENGINE_CC.map(c => <option key={c} value={c}>{c}</option>)}
                    </select>
                  </div>
                  <div style={ms.editField}>
                    <label style={ms.editLabel}>Color</label>
                    <select style={ms.editSelect} value={edit.color} onChange={e => setF("color", e.target.value)}>
                      <option value="">Select</option>
              ...
              <div style={ms.editSection}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr auto 1fr", gap: "14px", alignItems: "end" }}>
                  ...
                  <button onClick={calcBalance} style={{ background: TEAL, color: "#fff", border: "none", borderRadius: 7, padding: "8px 14px", cursor: "pointer", fontSize: ".9rem", height: 38, alignSelf: "end" }}>â†’</button>
                  <div style={ms.editField}>
    ...
    <div style={s.page}>
      ...
      <div style={s.tabsBar}>
        {TABS.map((tab) => (
          <button key={tab} onClick={() => handleTabClick(tab)}
            style={{ ...s.tab, ...(tab === "Sales History" ? s.tabActive : {}) }}>
            {tab}
          </button>
        ))}
      </div>
      ...
      <div style={s.card}>
        ...
        <div style={s.cardTopRow}>
          <div>
            <p style={s.cardTitle}>Sales History</p>
            <p style={s.cardSubtitle}>Detailed Sales Records For Administrative Reference</p>
          </div>
        </div>

        <div style={s.searchRow}>
          <input type="text"
            placeholder="Search by CNIC, Phone No, Chassis No, Engine No, Registration No etc"
            value={searchQuery}
