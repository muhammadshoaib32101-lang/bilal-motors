...
<div class="section"><div class="section-title">Vehicle Details</div><div class="row"><div class="f"><div class="f-label">Maker</div><div class="f-value">${val(form.maker)}</div></div><div class="f"><div class="f-label">Model Year</div><div class="f-value">${val(form.modelYear)}</div></div><div class="f"><div class="f-label">Registration No. (New)</div><div class="f-value">${val(form.regNoNew)}</div></div></div><div class="row"><div class="f"><div class="f-label">Chassis No.</div><div class="f-value">${val(form.chassisNo)}</div></div><div class="f"><div class="f-label">Engine No.</div><div class="f-value">${val(form.engineNo)}</div></div></div></div>
<hr class="sec-divider"/>
    ...
    try {
      const res = await fetch("/api/registration/new", {
        ...
        body: JSON.stringify({
          ...
          regNoNew: form.regNoNew, chassisNo: form.chassisNo,
          engineNo: form.engineNo, date: form.date,
