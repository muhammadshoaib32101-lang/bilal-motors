      ...
      <div style={s.card}>
        ...
        <div style={s.tableWrapper}>
          <table style={s.table}>
            ...
            <tbody>
              {loading ? (
                <tr><td colSpan={isTransfer ? 12 : 11} style={s.emptyRow}>Loading…</td></tr>
              ) : records.length === 0 ? (
                ...
                return (
                  <tr key={rec.id} style={idx % 2 === 0 ? s.trEven : s.trOdd}>
                    ...
                    {isTransfer && <td style={s.td}>{rec.regNoOld || "—"}</td>}
                    <td style={s.td}>{rec.regNoNew || "—"}</td>
                    <td style={s.td}>{rec.chassisNo}</td>
                    <td style={s.td}>{rec.engineNo}</td>
                    <td style={s.td}>{docList || "—"}</td>
