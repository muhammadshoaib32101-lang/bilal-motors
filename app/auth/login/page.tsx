    ...
    <>
      <style>{`
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Bicycle silhouette â€” subtle top-left watermark */
        .deco {
          position: absolute;
          top: 0;
          left: 0;
      ...
      <div className="page">
        ...
        {/*
          MOTORCYCLE PHOTO (Image 1 â€” the teal-wall motorcycle)
          â€” fills the entire right half of the screen
          â€” once you set MOTORCYCLE_IMAGE above, the placeholder disappears automatically
        */}
        <div className="right">
          {MOTORCYCLE_IMAGE !== "/images/motorcycle.jpg" ? (
            ...
            <div className={`${poppins.className} placeholder`}>
              ...
              <p>
                ...
                Open <strong>page.jsx</strong> â†’ find line:<br/>
