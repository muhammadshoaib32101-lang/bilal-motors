...
const MOTORCYCLE_IMAGE = "/images/motorcycle1.jpg";
...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showToast("Network error. Make sure your server is running.");
    }
  };
    ...
    <>
      <style>{`
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Bicycle silhouette watermark, tinted to teal */
        .deco {
          position: absolute;
          top: 0;
          left: 0;
        ...
        .toast.error  { background: #B92C14; color: #fff; }
        .toast.success{ background: #1A6B3A; color: #fff; }
      ...
      {toast && (
        <div className={poppins.className + " toast " + toast.type} role="alert">
          <span className="toast-icon">
            {toast.type === "error" ? (
              <svg width="16" height="16" viewBox="0 0 20 20" fill="none">
                <circle cx="10" cy="10" r="8.5" stroke="currentColor" strokeWidth="1.7"/>
