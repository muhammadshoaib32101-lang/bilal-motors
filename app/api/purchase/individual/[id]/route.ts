...
// ── GET  /api/purchase/individual/[id] ───────────────────────
export async function GET(
  ...
  try {
    ...
    console.error("[GET /api/purchase/individual/[id]]", err);
    return NextResponse.json({ success: false, message: "Server error" }, { status: 500 });
  }
}

// ── PUT  /api/purchase/individual/[id] ───────────────────────
export async function PUT(
  ...
  try {
    ...
    await pool.query<ResultSetHeader>(
      `UPDATE individual_purchases SET
       ...
       WHERE id = ?`,
      [
        b.seller_name, b.father_name, b.phone, b.date, b.cnic, b.address,
    ...
    console.error("[PUT /api/purchase/individual/[id]]", err);
    return NextResponse.json({ success: false, message: "Update failed" }, { status: 500 });
  }
}

// ── DELETE /api/purchase/individual/[id] ─────────────────────
export async function DELETE(
  ...
  try {
    ...
    const [result] = await pool.query<ResultSetHeader>(
      "DELETE FROM individual_purchases WHERE id = ?",
      [id]
    );
    ...
    console.error("[DELETE /api/purchase/individual/[id]]", err);
    return NextResponse.json({ success: false, message: "Server error" }, { status: 500 });
  }
}
